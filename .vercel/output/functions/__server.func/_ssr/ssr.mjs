...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BjP2oSGw.mjs");
...
var manifest = {
	"32acf49916632c960adf2a0878f0a8880374683b1eff56d33df4202e968932a5": {
		functionName: "dbResetDemo_createServerFn_handler",
		importer: () => import("./db-actions-C3CiGkZr.mjs")
	},
	"7c2fe20d684d7721e0ba1ae67947c4be818bb6514030111e6289c825fbbcd735": {
		functionName: "dbSignup_createServerFn_handler",
		importer: () => import("./db-actions-C3CiGkZr.mjs")
	},
	"ccf41574ad77e9c2123ac11a4f81b6bc532d2c455d7e0c7f49056828496d3357": {
		functionName: "fetchReliefData_createServerFn_handler",
		importer: () => import("./db-actions-C3CiGkZr.mjs")
	},
	"d312aa074e77191567d473556e3cee89824692922619b0dc39a8bd9a8f26af72": {
		functionName: "dbSaveTransaction_createServerFn_handler",
		importer: () => import("./db-actions-C3CiGkZr.mjs")
	},
	"d63e5d478844a54436417a88533307d056a8803553248d4d269884d064445f28": {
		functionName: "dbPostRequirement_createServerFn_handler",
		importer: () => import("./db-actions-C3CiGkZr.mjs")
	},
	"fda674c299e9ba9c2f745e73b6733f530405b74cdb86a8796d2016ede1ecc5d1": {
		functionName: "dbPostSurplus_createServerFn_handler",
		importer: () => import("./db-actions-C3CiGkZr.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-ClfUIAXn.mjs").then((n) => n.t),
