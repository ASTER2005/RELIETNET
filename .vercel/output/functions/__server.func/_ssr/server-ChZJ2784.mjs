import { i as getPglite, r as ensureDbReady } from "./seed-o426wP7e.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-ChZJ2784.js
...
var explicitBaseURL = env$1("BETTER_AUTH_URL") ?? (env$1("VERCEL_URL") ? `https://${env$1("VERCEL_URL")}` : void 0);
var previewAllowedHosts = [...PREVIEW_ALLOWED_HOSTS, "*.vercel.app"];
